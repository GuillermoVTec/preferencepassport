...
<head>
    ...
    <title><?php echo e('Preference Passport'); ?></title>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item ">
              ...
              <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'Verificacion')): ?>
                <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('nuevoVlo')); ?>" class="menu-link">
                ...
                <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('noVentaVlo')); ?>" class="menu-link">
                    <div data-i18n="Without menu"><i class="bx bx-x-circle"></i>  No Venta</div>
                                ...
                                <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('VentaVlo')); ?>" class="menu-link">
                    <div data-i18n="Without menu"><i class="bx bx-check-square"></i> Venta</div>
                                ...
                                <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('DP')); ?>" class="menu-link">
                    <div data-i18n="Without menu"><i class="bx bx-file-find"></i> Documentos Pendientes</div>
                                ...
                                <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('DC')); ?>" class="menu-link">
              ...
              <?php endif; ?>
               <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'Reservaciones')): ?>
                <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('abiertas')); ?>" class="menu-link">
                ...
                <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('DPR')); ?>" class="menu-link">
                    <div data-i18n="Without menu"><i class="bx bx-x-circle"></i>  Documentos Pendientes</div>
                                ...
                                <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('suspendida')); ?>" class="menu-link">
                    <div data-i18n="Without menu"><i class="bx bx-check-square"></i> Suspendida</div>
                                ...
                                <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('rechazada')); ?>" class="menu-link">
                    <div data-i18n="Without menu"><i class="bx bx-file-find"></i> Rechazada por el hotel</div>
                                ...
                                <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('cancelada')); ?>" class="menu-link">
                    ...
                    <div data-i18n="Without menu"><i class="bx bx-file"></i> Cancelada</div>
                                                ...
                                                <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('solicitada')); ?>" class="menu-link">
                    ...
                    <div data-i18n="Without menu"><i class="bx bx-file"></i> Solicitada</div>
                                                ...
                                                <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('fee')); ?>" class="menu-link">
                    ...
                    <div data-i18n="Without menu"><i class="bx bx-file"></i> Pago de fee pendiente</div>
                                                ...
                                                <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('pre')); ?>" class="menu-link">
                    ...
                    <div data-i18n="Without menu"><i class="bx bx-file"></i> Pre confirmada</div>
                                                ...
                                                <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('confirmada')); ?>" class="menu-link">
             ...
             <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'Gerente')): ?>
                 <li class="menu-item">
                     <a href="<?php echo e(route('leadsCreate')); ?>" class="menu-link">
                ...
                <li class="menu-item">
                 ...
                 <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('asignar')); ?>" class="menu-link">
                ...
                <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('reasignar')); ?>" class="menu-link">
              ...
              <?php endif; ?>
                ...
                <?php endif; ?>
                <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'Administradorr')): ?>
                </ul>
                <ul class="menu-sub">
                <li class="menu-item">
                    <a href="<?php echo e(route('asignar')); ?>" class="menu-link">
                ...
                <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('nuevo')); ?>" class="menu-link">
                    <div data-i18n="Without menu"><i class='bx bx-task'></i>Nueva</div>
                    </a>
                </li>
                </ul>
                ...
                <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('seguimiento')); ?>" class="menu-link">
               ...
               <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('nocontesto')); ?>" class="menu-link">
                ...
                <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('nointeresado')); ?>" class="menu-link">
                ...
                <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('datosincorrectos')); ?>" class="menu-link">
                ...
                <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('activados')); ?>" class="menu-link">
                ...
                <ul class="menu-item">
                <li class="menu-item">
                    <a href="<?php echo e(route('preregistro')); ?>" class="menu-link">
            ...
            <li class="menu-item ">
             ...
             <li class="menu-item">
              <a href="<?php echo e(route('register')); ?>" class="menu-link menu-toggle">
             ...
             <li class="menu-item ">
              <a href="<?php echo e(route('distribuidores.index')); ?>" class="menu-link menu-toggle">
                ...
                <div data-i18n="Analytics">Cerradores</div> 
                 ...
                 <ul class="menu-sub">
                 <li class="menu-item">
                     <a href="<?php echo e(route('CerradorCreate')); ?>" class="menu-link">
                ...
                <ul class="menu-sub">
                <li class="menu-item">
                    <a href="<?php echo e(route('cerrador')); ?>" class="menu-link">
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                          <li class="nav-item lh-1 me-3">
                           ...
                           <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'Reservaciones')): ?>
                            ...
                            <?php endif; ?>
                            <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'Distribuidor')): ?>
                            <span class="fw-semibold d-block"><?php echo e(Auth::user()->distribuidore->representantelegal); ?></span>
                         ...
                         <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                 <a id="nav-link dropdown-toggle hide-arrow" class=" dropdown" href="<?php echo e(route('home')); ?>" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                 <div class="avatar avatar-online">
                                 <img src=" <?php echo e(Auth::user()->getMedia('avatars')->first()->getUrl('thumb')); ?>" alt class="w-px-40 h-auto rounded-circle">
                                 </div>
                                 </a>                          
...
<?php /**PATH /home/soaonjvfyv03/public_html/prueba/preferencepassport/resources/views/layouts/app.blade.php ENDPATH**/ ?>