                ...
                <div class="col-md-6">
                 <div class="d-flex align-items-start align-items-sm-center gap-4">
                  ...
                  <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <label for="basic-default-password" class="col-md-4 col-form-label text-md-end">{{ __('Password') }}</label>
                         ...
                         <div class="row mb-3">
                            <label   class="col-md-4 col-form-label text-md-end" for="basic-default-password-confirm" >{{ __('Confirm Password') }}</label>
                        <div class=" form-password-toggle  col-md-6 form-password-toggle">
                        ...
                        <div class="col-md-6">
                        <select name='roles' id="roles" class="form-select @error('roles') is-invalid @enderror" id="exampleFormControlSelect1">
                        
                        <option tipe="hidden" value="{{ old('roles') }}">{{ old('roles') }} </option>
                        ...
                        <option value="Gerente Ventas">Gerente Ventas</option>
                                 ...
                                 @error('roles')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ 'Selecione un rol' }}</strong>
                                    </span>
                                @enderror
                        </div>
                        </div>
