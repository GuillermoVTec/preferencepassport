                  ...
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                            @role('Verificacion')
                            <h5 class="card-title "style="color: #0376aa">Bienvenido (a) {{ Auth::user()->name }}! 🎉</h5>
                            @endrole
                            @role('Gerente')
                            <h5 class="card-title "style="color: #0376aa">Bienvenido (a) {{ Auth::user()->name }}! 🎉</h5>
                            @endrole
                           ...
                           @endrole
                           @role('Distribuidor')
                           <h5 class="card-title " style="color: #0376aa"> Bienvenido (a)  {{ Auth::user()->distribuidore->representantelegal }} ! 🎉</h5>
                            @endrole
                          <p class="mb-4">
