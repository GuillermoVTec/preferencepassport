    ...
    <div class="col-md-12">
      ...
      <div class="card card-default">
        ...
        <div class="card-body">
          ...
          @if($lead->nombre && $lead->edad && $lead->estadocivil &&   $lead->telefono1 &&    $lead->telefono2 &&  $lead->correo &&  $lead->pais &&   $lead->statuses_id  &&   $worksheet->id  && $worksheet->ocupaciont &&    $worksheet->calificacion && $worksheet->booking &&  $worksheet->nombrec && $worksheet->edadc &&  $worksheet->ocupácionc &&   $worksheet->estadocivilc &&    $worksheet->ingresos &&  $worksheet->tarjetas &&   $worksheet->ciudad && $worksheet->cp && $worksheet->leads_id && $ddr->destino  && $ddr->hotel  && $ddr->menores && $ddr->noches  && $ddr->habitaciones && $ddr->tipo_habitacion && $ddr->adultos && $ddr->menores && $ddr->plan && $ddr->worksheet_id &&  $ddp2 === null)
          <div class="col-md-6">
            <div class=" mb-4">
              <h5 class="card-header">DATOS DE TARIFAS
                <small class="text-muted float-end">Moneda
                  <select id="smallSelect" class="form-select form-select-sm" name="moneda" required>
              ...
              <div class="card-body demo-vertical-spacing demo-only-element">
                ...
                <div class="form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                   <input value="{{ old('pakeo_agente') }}" autofocus type="text" class="form-control @error('pakeo_agente') is-invalid @enderror" id="basic-default-name"  name="pakeo_agente" style="border-bottom: solid 1px #ccc !important; border: none; border-radius: none; width: 100%;"/>
                   @error('pakeo_agente')
                   <span class="invalid-feedback" role="alert">
                    <strong>{{ 'campo obligatorio' }}</strong>
                  </span>
              ...
              <div class="form-password-toggle">
                ...
                <div class="input-group input-group-merge">
                 <input value="{{ old('activacion') }}" autofocus type="text" class="form-control @error('activacion') is-invalid @enderror" id="basic-default-name"  name="activacion" style="border-bottom: solid 1px #ccc !important; border: none; border-radius: none; width: 100%;"/>
                 @error('activacion')
                 <span class="invalid-feedback" role="alert">
                  <strong>{{ 'campo obligatorio' }}</strong>
                </span>
            ...
            <div class="form-password-toggle">
              ...
              <div class="input-group input-group-merge">
               <input value="{{ old('reporte_fee') }}" autofocus type="text" class="form-control @error('reporte_fee') is-invalid @enderror" id="basic-default-name"  name="reporte_fee" style="border-bottom: solid 1px #ccc !important; border: none; border-radius: none; width: 100%;"/>
               @error('reporte_fee')
               <span class="invalid-feedback" role="alert">
                <strong>{{ 'campo obligatorio' }}</strong>
              </span>
          ...
          <div class="form-password-toggle">
            ...
            <div class="input-group input-group-merge">
              <input value="{{ old('pago_inicial') }}" autofocus class="form-control @error('pago_inicial') is-invalid @enderror" type="text"  name="pago_inicial" id="html5-date-input" />
              @error('pago_inicial')
              <span class="invalid-feedback" role="alert">
                <strong>{{ 'campo obligatorio' }}</strong>
              </span>
          ...
          <div class="form-password-toggle">
            ...
            <div class="input-group input-group-merge">
             <input value="{{ old('pendiente_de_pago') }}" autofocus type="text" class="form-control @error('pendiente_de_pago') is-invalid @enderror" id="basic-default-name"  name="pendiente_de_pago" style="border-bottom: solid 1px #ccc !important; border: none; border-radius: none; width: 100%;"/>
        ...
        <div class="form-password-toggle">
          ...
          <div class="input-group input-group-merge">
           <input value="{{ old('concepto') }}" autofocus type="text" class="form-control @error('concepto') is-invalid @enderror" id="basic-default-name"  name="concepto" style="border-bottom: solid 1px #ccc !important; border: none; border-radius: none; width: 100%;"/>
           @error('concepto')
           <span class="invalid-feedback" role="alert">
            <strong>{{ 'campo obligatorio' }}</strong>
          </span>
      ...
      <div class="form-password-toggle">
        ...
        <div class="input-group input-group-merge">
          <input value="{{ old('fecha_limite') }}" autofocus class="form-control @error('fecha_limite') is-invalid @enderror" type="date"  name="fecha_limite" id="html5-date-input" />
          @error('fecha_limite')
          <span class="invalid-feedback" role="alert">
            <strong>{{ 'campo obligatorio' }}</strong>
          </span>
      ...
      <div class="demo-inline-spacing mt-3">
        <div class="list-group">
          <label class="list-group-item">
            <input class="form-check-input @error('forma_pago') is-invalid @enderror" name="forma_pago"   type="radio" value="NuevaTarjeta"  data-bs-toggle="collapse.show"
            data-bs-target="#collapseExample3"
            aria-expanded="true"
            aria-controls="collapseExample3"
            @if((!old() && $myDefault = false ) || old('forma_pago') == 'NuevaTarjeta') checked="checked" @endif/>
            ...
            <div class="collapse.show" id="collapseExample3" style="background-color: #fff !important;">
              ...
              <div class="form-password-toggle">
                ...
                <div class="input-group input-group-merge">
                  <input type="text" class="@error('banco') is-invalid @enderror" value="{{ old('banco') }}" name="banco" id="basic-default-name" style="border-bottom: solid 1px #ccc !important; border: none; border-radius: none; width: 100%;"/>
                  @error('banco')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ 'campo obligatorio' }}</strong>
                  </span>
              ...
              <div class="form-password-toggle">
                ...
                <div class="input-group input-group-merge">
                  <input type="text" class="@error('titular') is-invalid @enderror" value="{{ old('titular') }}" name="titular" id="basic-default-name" style="border-bottom: solid 1px #ccc !important; border: none; border-radius: none; width: 100%;"/>
                  @error('titular')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ 'campo obligatorio' }}</strong>
                  </span>
              ...
              <div class="mb-3 col-md-8">
                ...
                <div class="form-check form-check-inline mt-2">
                  <input class="form-input @error('afiliacion') is-invalid @enderror" type="radio" value="VISA" name="afiliacion" id="inlineRadio1"
                  @if((!old() && $myDefault = false ) || old('afiliacion') == 'VISA') checked="checked" @endif />
                  @error('afiliacion')<span class="invalid-feedback" role="alert"><strong>{{ 'campo obligatorio' }}</strong></span> @enderror
                  <label class="form-label" for="inlineRadio1">VISA</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-input @error('afiliacion') is-invalid @enderror" type="radio" value="MC" name="afiliacion" id="inlineRadio2"
                  @if((!old() && $myDefault = false ) || old('afiliacion') == 'MC') checked="checked" @endif  />
                  @error('afiliacion')<span class="invalid-feedback" role="alert"><strong>{{ 'campo obligatorio' }}</strong></span> @enderror

                  <label class="form-label" for="inlineRadio2">MC</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-input @error('afiliacion') is-invalid @enderror" type="radio" value="AMEX" name="afiliacion"  id="inlineRadio3"
                  @if((!old() && $myDefault = false ) || old('afiliacion') == 'AMEX') checked="checked" @endif  />
                  @error('afiliacion')<span class="invalid-feedback" role="alert"><strong>{{ 'campo obligatorio' }}</strong></span> @enderror
              ...
              <div class="form-password-toggle">
                ...
                <div class="input-group input-group-merge">
                  <input type="text" class="@error('digitos') is-invalid @enderror" maxlength="16" value="{{ old('digitos') }}" name="digitos" id="basic-default-name" style="border-bottom: solid 1px #ccc !important; border: none; border-radius: none; width: 100%;"/>
                  @error('digitos')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ 'campo obligatorio' }}</strong>
                  </span>
              ...
              <div class="mb-3 col-md-7">
                ...
                <div class="input-group">
                  <input type="text" class="form-control validar @error('vigencia') is-invalid @enderror" value="{{ old('vigencia') }}" name="vigencia" maxlength="5">
                  @error('vigencia')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ 'campo obligatorio' }}</strong>
                  </span>
              ...
              <div class="mb-3 col-md-4" style="float: right; margin-top:-68px !important;">
                ...
                <input class="form-control validar @error('CVV') is-invalid @enderror" value="{{ old('CVV') }}"  name="CVV" type="text" maxlength="4"/>
                @error('CVV')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ 'campo obligatorio' }}</strong>
                </span>
              ...
              <div>
               ...
               <textarea class="form-control @error('nota') is-invalid @enderror" name="nota" value="{{ old('nota') }}" id="exampleFormControlTextarea1" rows="3"></textarea>
               @error('nota')
               <span class="invalid-feedback" role="alert">
                <strong>{{ 'campo obligatorio' }}</strong>
              </span>
        ...
        <label class="list-group-item">
          ...
          @if((!old() && $myDefault= false) || old('forma_pago') == 'Transferencia') checked="checked" @endif/>
          Transferencia
          @error('forma_pago')<span class="invalid-feedback" role="alert"><strong>{{ 'campo obligatorio' }}</strong></span> @enderror
        </label>
        ...
        <label class="list-group-item">
          ...
          @if((!old() && $myDefault= false) || old('forma_pago') == 'PagoenLinea') checked="checked" @endif/>
          @error('forma_pago')<span class="invalid-feedback" role="alert"><strong>{{ 'campo obligatorio' }}</strong></span> @enderror
          Pago en Linea
       ...
       <div class="d-flex align-items-start align-items-sm-center gap-4">
        ...
        <div class="button-wrapper">
          <label for="avatarFile" class="btn btn-primary me-2 mb-4" tabindex="0">
            ...
            class="account-file-input @error('comprovante') is-invalid @enderror"
            hidden
...
<div class="table-responsive text-nowrap">
 <table class="table table-hover">
  ...
  <tbody class="table-border-bottom-0">
    @foreach ($ddp2 as $pago)
    <tr>

     @if($worksheet->moneda == 'mxm')
      <td>{{ ++$i }}</td>
      <td>{{ $pago->id }}</td>
      <td>$ {{ $pago->costo_total }} MXM </td>
      <td>$ {{ $pago->pakeo_agente }} MXM </td>
      <td>$ {{ $pago->activacion }} MXM </td>
      <td>$ {{ $pago->reporte_fee }} MXM </td>
      <td>$ {{ $pago->pago_inicial }} MXM </td>
      <td>$ {{ $pago->pendiente_de_pago }} MXM </td>
    ...
    @endswitch
     ...
     @if($worksheet->moneda == 'usd')
      <td>{{++$i}}</td>
      <td>{{$pago->id}}</td>
      <td>${{ $pago->costo_total }} USD</td>
      <td>${{ $pago->pakeo_agente }} USD</td>
      <td>${{ $pago->activacion }} USD</td>
      <td>${{ $pago->reporte_fee }} USD</td>
      <td>${{ $pago->pago_inicial }} USD</td>
      <td>${{ $pago->pendiente_de_pago }} USD</td>
      <td> {{ $pago->created_at}}</td>
    @switch($pago->forma_de_pago)
    @case('PagoenLinea')
        <td>{{'Pago en linea' }}</td>
            ...
            <div class="card-body demo-vertical-spacing demo-only-element">
              <div class="demo-inline-spacing mt-3">
                <div class="list-group">
                      ...
                      <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                         ...
                         <td class="mb-3 col-md-1" ><input class="form-check-input @error('formaPago2') is-invalid @enderror" type="radio" name="formaPago2"  value="{{$forma->digitos}}" 
                           @if((!old() && $myDefault = "" ) || old('formaPago2') == $forma->digitos) checked="checked" @endif />
                           @error('formaPago2')
                           <span class="invalid-feedback" role="alert">
                            <strong>{{ 'campo obligatorio' }}</strong>
                          </span>
                  ...
                  <label class="list-group-item">
                    <input class="form-check-input @error('formaPago2') is-invalid @enderror" type="radio" name="formaPago2" value="nuevatarjeta" id="inlineRadio1" data-bs-toggle="collapse"
                    data-bs-target="#collapseExample3"
                    aria-expanded="true"
